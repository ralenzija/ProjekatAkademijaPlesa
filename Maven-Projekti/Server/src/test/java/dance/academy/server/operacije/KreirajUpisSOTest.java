...
/**
 * Test klasa za KreirajUpisSO.
 */
public class KreirajUpisSOTest {

    private KreirajUpisSO kreirajUpisSO;
    ...
    public void setUp() throws Exception {
        ...
        kreirajUpisSO = new KreirajUpisSO(mockBroker);
        ...
        upis = new UpisNaProgram(0, new Date(), StatusUpisa.KREIRAN, 5000.0,
    ...
    public void testPredusluviNullParam() {
        assertThrows(Exception.class,
                () -> kreirajUpisSO.izvrsi(null, null),
    ...
    public void testPredusluviPogresanTip() {
        assertThrows(Exception.class,
                () -> kreirajUpisSO.izvrsi("pogresanTip", null),
    ...
    public void testPredusluviUpisBezStavki() {
        ...
        assertThrows(Exception.class,
                () -> kreirajUpisSO.izvrsi(upis, null),
    ...
    @Test
    public void testKreirajUpisValidanUpisPozivaAdd() throws Exception {
        Mockito.when(mockBroker.add(Mockito.any(UpisNaProgram.class))).thenReturn(1);

        kreirajUpisSO.izvrsi(upis, null);

        Mockito.verify(mockBroker, Mockito.atLeastOnce()).add(Mockito.any());
    }

    @Test
    public void testGetUpisNakonKreiranja() throws Exception {
        Mockito.when(mockBroker.add(Mockito.any(UpisNaProgram.class))).thenReturn(1);

        kreirajUpisSO.izvrsi(upis, null);

        assertNotNull(kreirajUpisSO.getUpis(), "Upis ne sme biti null nakon kreiranja");
    }
}