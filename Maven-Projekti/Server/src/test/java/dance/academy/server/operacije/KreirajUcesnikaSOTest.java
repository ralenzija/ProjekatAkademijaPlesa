...
/**
 * Test klasa za KreirajUcesnikaSO.
 */
public class KreirajUcesnikaSOTest {

    private KreirajUcesnikaSO kreirajUcesnikaSO;
    ...
    public void setUp() throws Exception {
        ...
        kreirajUcesnikaSO = new KreirajUcesnikaSO(mockBroker);
    ...
    public void testPredusluviValidanUcesnik() {
        assertDoesNotThrow(() -> kreirajUcesnikaSO.izvrsi(ucesnik, null),
    ...
    public void testPredusluviNullParam() {
        assertThrows(Exception.class,
                () -> kreirajUcesnikaSO.izvrsi(null, null),
    ...
    public void testPredusluvipogresanTip() {
        assertThrows(Exception.class,
                () -> kreirajUcesnikaSO.izvrsi("pogresanTip", null),
                "Mora baciti izuzetak za pogresan tip parametra");
    }

    @Test
    public void testKreirajUcesnikaPozivaAdd() throws Exception {
        kreirajUcesnikaSO.izvrsi(ucesnik, null);
        Mockito.verify(mockBroker, Mockito.times(1)).add(ucesnik);
    }

    @Test
    public void testGetUcesnikNakonKreiranja() throws Exception {
        kreirajUcesnikaSO.izvrsi(ucesnik, null);
        assertEquals(ucesnik, kreirajUcesnikaSO.getUcesnik(),
                "Ucesnik treba biti isti nakon kreiranja");
    }
}